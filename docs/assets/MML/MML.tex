...
where $Z_i = (X_i, Y_i)$. This is a direct generalisation of our previous work, but what is more problematic when $|\H| = \infty$ is that our usual union bounding trick will fail miserably. % Note that trying to do things like in the finite case will be ill-fated because infinite sums are yikes.
...
for an perturbed $i$. Such an inequality is called a \vocab{bounded differences property}.
